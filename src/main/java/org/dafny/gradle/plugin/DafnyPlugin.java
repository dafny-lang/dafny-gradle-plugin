...
public class DafnyPlugin implements Plugin<Project> {
  ...
  public void apply(Project project) {
    ...
    TaskProvider<DafnyVersionCheckTask> dafnyVersionCheckProvider =
        project.getTasks().register("checkDafnyVersion", DafnyVersionCheckTask.class);
    TaskProvider<DafnyVerifyTask> dafnyVerifyProvider =
        project.getTasks().register("verifyDafny", DafnyVerifyTask.class);
    TaskProvider<DafnyTranslateTask> dafnyTranslateProvider =
        project.getTasks().register("translateDafnyToJava", DafnyTranslateTask.class);

    // TODO: Configurable file collection in extension for Dafny source files,
    // possibly sourceSet with doo file location as output.
    FileCollection dafnySourceFiles =
        project.fileTree("src/main/dafny", t -> t.include("**/*.dfy").include("**/*.doo"));
    ...
    dafnyVersionCheckProvider.configure(
        dafnyVersionCheckTask -> {
    ...
    dafnyTranslateProvider.configure(
        dafnyTranslateTask -> {
    ...
    javaExt
        ...
        .findByName("main")
        .getJava()
        .srcDir(new File(translatedJavaDir.getPath() + "-java"));

    // Make sure the Dafny-generated code is generated before compiling
    project
        .getTasks()
        .withType(JavaCompile.class, javaCompile -> javaCompile.dependsOn(dafnyTranslateProvider));
